    ...
    <div class="w-full  mt-6 pl-0 lg:pl-2">
        ...
        <div class="leading-loose">
            <form class="p-10 bg-white rounded shadow-xl" action="{{ route('user.post') }}" method="POST">
                ...
                <div class="mt-1 p-2">
                    <label class="block text-sm mb-1 text-gray-600" for="name">Name</label>
                ...
                <div class="mt-1 p-2">
                    ...
                    <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="role" name="role"
                        type="text" required="" placeholder=" Role" aria-label="Role">
                </div>

                <div class="mt-1 p-2">
                    <label class="block text-sm mb-1 text-gray-600" for="password">Password</label>
                    <input class="w-full px-5  py-1text-gray-700 bg-gray-200 rounded" id="password" name="password"
                        type="text" required="" placeholder="Your Password" aria-label="Password">
                </div>

                <div class="mt-1 p-2">
                    <label class="block text-sm mb-1 text-gray-600" for="password">Password</label>
                    <input class="w-full px-5  py-1text-gray-700 bg-gray-200 rounded" id="password"
                        name="password_confirmation" type="text" required="" placeholder="Your Password"
                        aria-label="Password">
                </div>
